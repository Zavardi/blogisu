        ...
        <div class="page-width">
            <div class="page-articles">
                    ...
                    <div class="card text-center">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="true" href="/ListArticles">Все статьи</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/InfCategorie">Информатика</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/MathCategorie">Математика</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                ...
                <div v-for="(article, index) in articles" :key="index">
                    <div v-if="article.categorie_id > 0">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-12">
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title" style="" type="submit" @click="goToArticle(article.id)"> {{
                                            article.title }}</h5>
